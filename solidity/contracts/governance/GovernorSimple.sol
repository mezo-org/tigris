...
abstract contract GovernorSimple is ERC2771Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function propose(
        ...
        bytes32 epochStart = bytes32(MezodromeTimeLibrary.epochStart(block.timestamp) + (1 weeks));
    ...
    function execute(
        ...
        bytes32 epochStart = bytes32(MezodromeTimeLibrary.epochStart(block.timestamp));
        uint256 proposalId = hashProposal(targets, values, calldatas, epochStart);
