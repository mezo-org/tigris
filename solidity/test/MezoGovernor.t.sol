...
contract MezoGovernorTest is BaseTest {
    ...
    function testCannotVetoIfNotVetoer() public {
        ...
        calldatas[0] = abi.encodeWithSelector(voter.whitelistToken.selector, address(mUSD));
    ...
    function testCannotProposeWithoutSufficientBalance() public {
        ...
        values[0] = 0;
        bytes[] memory calldatas = new bytes[](1);
        calldatas[0] = abi.encodeWithSelector(voter.whitelistToken.selector, address(mUSD), true);
        string memory description = "Whitelist mUSD";
