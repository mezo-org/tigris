...
contract FeesVotingRewardTest is BaseTest {
    ...
    function _setUp() public override {
        ...
        BTC.transfer(address(gauge), TOKEN_1 * 100);
        LIMPETH.transfer(address(gauge2), TOKEN_1 * 100);
        mUSD.transfer(address(gauge), mUSD_1 * 100);
        mUSD.transfer(address(gauge2), mUSD_1 * 100);
    }

    function testCannotNotifyRewardAmountIfNotGauge() public {
        BTC.approve(address(feesVotingReward), TOKEN_1);
    ...
    function testGetRewardWithZeroTotalSupply() public {
        ...
        uint256 earned = feesVotingReward.earned(address(BTC), 1);
        assertEq(earned, TOKEN_1);

        // add reward for epoch 2
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), TOKEN_1 * 2);
        ...
        earned = feesVotingReward.earned(address(BTC), 1);
        assertEq(earned, TOKEN_1);
    ...
    function testGetRewardWithMultipleStaggeredRewardsInOneEpoch() public {
        ...
        // create a reward
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), reward);
        feesVotingReward.notifyRewardAmount(address(BTC), reward);
        vm.stopPrank();
        ...
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), reward2);
        feesVotingReward.notifyRewardAmount((address(BTC)), reward2);
        vm.stopPrank();
        ...
        // expect both rewards
        uint256 totalBTCReward = reward + reward2;
        assertEq(post - pre, totalBTCReward);
    }
    ...
    function testCannotGetRewardMoreThanOncePerEpochWithSingleReward() public {
        ...
        uint256 post_post = BTC.balanceOf(address(owner));
    ...
    function testGetRewardWithVotesForDifferentPoolsAcrossEpochs() public {
        ...
        LIMPETH.approve(address(feesVotingReward2), reward2);
        feesVotingReward2.notifyRewardAmount((address(LIMPETH)), reward2);
        vm.stopPrank();
        pools[0] = address(pool2);
        ...
        rewards2[0] = address(LIMPETH);

        // check rewards accrue correctly for pool2
        pre = LIMPETH.balanceOf(address(owner));
        vm.prank(address(voter));
        feesVotingReward2.getReward(1, rewards2);
        post = LIMPETH.balanceOf(address(owner));
    ...
    function testGetRewardWithPassiveVote() public {
        ...
        feesVotingReward.notifyRewardAmount(address(BTC), TOKEN_1 * 2);
        vm.stopPrank();
        assertEq(BTC.balanceOf(address(feesVotingReward)), TOKEN_1 * 2);
        ...
        pre = BTC.balanceOf(address(owner));
        vm.prank(address(voter));
        feesVotingReward.getReward(1, rewards);
        post = BTC.balanceOf(address(owner));
    ...
    function testGetRewardWithPassiveVotes() public {
        ...
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), TOKEN_1 * 3);
        feesVotingReward.notifyRewardAmount((address(BTC)), TOKEN_1 * 3);
        vm.stopPrank();
        skip(1);
        ...
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), TOKEN_1 * 4);
        feesVotingReward.notifyRewardAmount((address(BTC)), TOKEN_1 * 4);
        vm.stopPrank();
        skip(1);
        ...
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), TOKEN_1 * 5);
        feesVotingReward.notifyRewardAmount((address(BTC)), TOKEN_1 * 5);
        vm.stopPrank();
        skip(1);
        ...
        vm.startPrank(address(gauge));
        BTC.approve(address(feesVotingReward), TOKEN_1 * 6);
        feesVotingReward.notifyRewardAmount((address(BTC)), TOKEN_1 * 6);
        vm.stopPrank();
        skip(1);
    ...
    function testGetRewardWithSingleCheckpointWithOtherVoter() public {
        ...
        pre = BTC.balanceOf(address(owner2));
        vm.prank(address(voter));
        feesVotingReward.getReward(2, rewards);
        post = BTC.balanceOf(address(owner2));
        assertEq(post - pre, TOKEN_1 / 2);
    }
    ...
    function testGetRewardWithSkippedClaims() public {
        ...
        feesVotingReward.notifyRewardAmount(address(BTC), reward);
        vm.stopPrank();
        assertEq(BTC.balanceOf(address(feesVotingReward)), reward);
        ...
        earned = feesVotingReward.earned(address(BTC), 2);
        assertEq(earned, expectedReward);
        ...
        feesVotingReward.notifyRewardAmount(address(BTC), reward2);
        vm.stopPrank();
        assertEq(BTC.balanceOf(address(feesVotingReward)), reward + reward2);
    ...
    function testCannotClaimRewardForPoolIfPokedButVotedForOtherPool() public {
        ...
        // create a reward for pool2 in epoch 1
        vm.startPrank(address(gauge2));
        LIMPETH.approve(address(feesVotingReward2), TOKEN_1 * 2);
        feesVotingReward2.notifyRewardAmount(address(LIMPETH), TOKEN_1 * 2);
        vm.stopPrank();
        skip(1 hours);
        ...
        earned = feesVotingReward2.earned(address(LIMPETH), 1);
        assertEq(earned, TOKEN_1 * 2);
    ...
    function testGetRewardWithVotesForMultiplePools() public {
        ...
        feesVotingReward.notifyRewardAmount(address(BTC), TOKEN_1);
        vm.stopPrank();
        // create a musd reward in epoch 1 for pool2
        vm.startPrank(address(gauge2));
        mUSD.approve(address(feesVotingReward2), mUSD_1);
        feesVotingReward2.notifyRewardAmount(address(mUSD), mUSD_1);
        vm.stopPrank();
        ...
        rewards[0] = address(mUSD);
        pre = mUSD.balanceOf(address(owner));
        vm.prank(address(voter));
        feesVotingReward2.getReward(1, rewards);
        post = mUSD.balanceOf(address(owner));
        assertEq(post - pre, (mUSD_1 * 4) / 5);

        pre = mUSD.balanceOf(address(owner2));
        vm.prank(address(voter));
        feesVotingReward2.getReward(2, rewards);
        post = mUSD.balanceOf(address(owner2));
        assertEq(post - pre, mUSD_1 / 5);
    }
    ...
    function testCannotGetRewardForNewPoolVotedAfterEpochFlip() public {
        ...
        uint256 pre = mUSD.balanceOf(address(owner));
        vm.prank(address(voter));
        feesVotingReward2.getReward(1, rewards);
        uint256 post = mUSD.balanceOf(address(owner));
        assertEq(post - pre, 0);
    ...
    function testCannotGetRewardInSameEpochAsVoteWithFuzz(uint256 ts) public {
        ...
        assertEq(feesVotingReward.earned(address(BTC), 1), 0);
    }
    ...
    function testGetRewardWithSeparateRewardClaims() public {
        ...
        // create musd reward, vote passively this epoch
        mUSD.transfer(address(gauge), mUSD_1);
        vm.startPrank(address(gauge));
        mUSD.approve(address(feesVotingReward), mUSD_1);
        feesVotingReward.notifyRewardAmount(address(mUSD), mUSD_1);
        vm.stopPrank();

        uint256 earned = feesVotingReward.earned(address(BTC), 1);
        assertEq(earned, TOKEN_1 / 2);

        earned = feesVotingReward.earned(address(mUSD), 1);
        assertEq(earned, 0);
